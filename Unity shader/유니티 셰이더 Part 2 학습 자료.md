...
이 문서는 '유니티 셰이더 16주 완성 커리큘럼'의 Part 2 내용을 보충하는 학습 자료입니다. 조명 계산, 블렌딩, 정점 애니메이션 등 중급 셰이더 기법을 학습하여 표현의 폭을 넓히는 것을 목표로 합니다.
...
과제 가이드
5주차 코드에 Blinn-Phong 정반사 계산을 추가한 코드입니다.
```c
